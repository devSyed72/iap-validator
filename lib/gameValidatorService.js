...
class GameValidatorService {
    ...
    async validatePurchase(gameConfig, purchaseData) {
        ...
        if (cachedResult) {
            console.log(`Cache hit for ${gameId} - Product: ${productId}, OrderId: ${cachedResult.transactionId || "none"}, TokenHash: ${tokenHash}`);
        ...
        try {
            ...
            console.log(`Validation for ${gameId} - Product: ${productId}, State: ${purchaseDetails.purchaseState}, ConsumptionState: ${purchaseDetails.consumptionState}, OrderId: ${purchaseDetails.orderId || "none"}, TokenHash: ${tokenHash}`);
            ...
            console.error(`Validation error for ${gameId} - Product: ${productId}, Code: ${error.code || "none"}, TokenHash: ${tokenHash} - ${error.message}`);
